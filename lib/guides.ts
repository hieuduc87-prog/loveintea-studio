...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Render xong xem preview / tải về (1080×1920, mix voiceover + nhạc ducking). Bật lồng tiếng → tự có caption KARAOKE từng từ chạy theo giọng đọc (85% người xem mute vẫn "đọc" được lời thoại).',
      'AI viết sẵn 3 HOOK khác kiểu (kết quả / cảnh báo sai lầm / tò mò) — lịch định kỳ tự xoay vòng hook qua các kỳ để test hook nào giữ người xem tốt nhất.',
