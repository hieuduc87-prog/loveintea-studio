...
const SECTIONS: Section[] = [
  ...
  {
    id: 'video_overview', icon: '🎥', kicker: 'Video A-Z · 1/5', title: 'Quy trình video tổng thể — làm ở tab nào?',
    intro: 'Hệ thống video gồm 3 khối: CHUẨN BỊ nguyên liệu (1 lần) → SẢN XUẤT (3 cách) → ĐĂNG & HỌC. AI làm 95% (kịch bản, chọn cảnh, cắt theo beat, chữ, lồng tiếng, mix nhạc) — bạn chỉ nạp nguyên liệu và duyệt.',
    steps: [
      'Tab 📦 Products: tải ảnh sản phẩm (nguyên liệu chính của mọi video).',
      'Tab 🎬 Video Studio: kho clip quay tay + 🎵 kho nhạc nền + tạo video tay + ⏰ Lịch định kỳ.',
      'Tab 🕵️ Nguồn học: dán link video viral đối thủ → AI học công thức thành "khuôn".',
      'Tab ✅ Review & Queue: duyệt bài video (icon 🎬) → đăng Facebook video / Instagram Reels.',
      'CHECKLIST 15 PHÚT: (1) Products đủ ảnh → (2) Video Studio: upload 5-10 clip → (3) nạp 5-10 bài nhạc → (4) Nguồn học: dán 2-3 link viral → (5) tạo 1 Lịch định kỳ → (6) 5 phút sau duyệt video đầu tiên ở Review & Queue.',
    ],
    tip: 'Chuẩn bị càng đầy (ảnh + clip + nhạc), video AI làm ra càng đẹp và càng ít phải sửa.',
  },
  {
    id: 'video_prep', icon: '📼', kicker: 'Video A-Z · 2/5', title: 'Chuẩn bị: Kho clip + Kho nhạc nền — tab 🎬 Video Studio',
    intro: 'Hai kho nguyên liệu nằm ngay trong tab Video Studio. Nạp một lần, mọi video (kể cả lịch tự động) dùng chung.',
    steps: [
      '📼 KHO CLIP: nút "+ Upload clip" — footage quay tay: rót trà, đá viên, tay cầm ly, quán, hậu trường (≤200MB/clip). AI tự gắn tag chủ thể/mood/chuyển động để chọn đúng cảnh.',
      'Chọn sản phẩm trước khi upload nếu clip thuộc riêng sản phẩm đó. Không có clip vẫn làm được video — AI dùng ảnh sản phẩm + ảnh AI.',
      '🎵 KHO NHẠC NỀN: bấm "Quản lý kho" → 3 cách nạp: dán LINK reel/video có nhạc hay (chỉ bóc phần audio) · upload VIDEO (tự tách nhạc) · upload MP3.',
      'Mỗi bài nhạc được detect sẵn BPM → video cắt cảnh đúng nhịp. Nạp 5-10 bài hợp vibe brand — lịch định kỳ tự xoay vòng đều.',
    ],
    warn: 'Nhạc lấy từ link có thể dính bản quyền khi chạy QUẢNG CÁO — đăng organic thì ổn; chạy ads nên dùng nhạc royalty-free. Nhạc trending: gắn native trong app lúc đăng, đừng nhúng vào file.',
  },
  {
    id: 'video_studio', icon: '🎬', kicker: 'Video A-Z · 3/5', title: 'Tạo video + ⏰ Lịch định kỳ — tab 🎬 Video Studio',
    intro: 'Tạo lẻ từng video, hoặc đặt Lịch định kỳ một lần để hệ thống tự sản xuất đều đặn.',
    steps: [
      'TẠO 1 VIDEO: chọn mục đích + sản phẩm + ngôn ngữ + thời lượng (12-45s) → chọn nhạc từ 🎵 kho (dropdown) hoặc upload riêng → bật 🎙️ Lồng tiếng → "🧠 Tạo storyboard" → xem kịch bản → "▶ Render" (~3-8 phút) → preview / ⬇ tải về.',
      '(Tuỳ chọn) "🎯 Học công thức từ video mẫu": chọn 1 clip viral trong kho — AI giữ cấu trúc, thay nội dung brand.',
      '⏰ LỊCH ĐỊNH KỲ: "+ Lịch mới" → xoay vòng sản phẩm (hoặc 1 SP cố định) · mỗi N ngày lúc X giờ VN · gắn Khuôn từ Nguồn học (tuỳ chọn) · 🎵 nhạc tự chọn từ kho · kênh FB/IG.',
      'Chế độ ra bài: "📝 Tạo bài nháp" (chờ bạn duyệt ở Review & Queue — khuyên dùng) hoặc "⚡ Tự đăng ngay khi render xong".',
      'Video đầu tiên của lịch chạy trong ≤5 phút. Theo dõi ở "Video projects"; công tắc bật/tắt từng lịch; dòng trạng thái hiện số video đã tạo + lần chạy kế tiếp + lỗi (nếu có).',
    ],
    tip: 'Muốn nhiều video để test: tạo 2-3 lịch với mục đích khác nhau (Quảng bá / Ritual / Giáo dục).',
  },
  {
    id: 'inspiration', icon: '🕵️', kicker: 'Video A-Z · 4/5', title: 'Nguồn học: học công thức viral + dán hàng loạt — tab 🕵️ Nguồn học',
    intro: 'Thấy video đối thủ viral? Dán link — AI xem toàn bộ video, bóc từng cảnh (nhịp cắt, góc máy, hook, cảm xúc) thành "khuôn" + bài học tiếng Việt, rồi dựng video của BẠN theo đúng công thức thắng.',
    steps: [
      'Thêm "Trang đang theo dõi" (page/kênh đối thủ) để nhóm bài — tùy chọn.',
      'HỌC 1 BÀI: dán link video công khai (IG Reels / FB / TikTok / YouTube) + caption gốc nếu muốn học cả công thức caption → "🧠 Nạp & phân tích" (vài phút).',
      '📥 DÁN HÀNG LOẠT (cho nhân viên sưu tầm): dán NHIỀU link vào ô "Dán hàng loạt — lưu hết", MỖI DÒNG 1 LINK (tối đa 50) → "📥 Lưu hết vào kho". Hệ thống tải lần lượt từng video về lưu trữ (badge "đã lưu video"), link trùng tự bỏ qua. Phân tích sau bằng nút 🧠 trên từng bài.',
      'Link private / tải lỗi → nút "📁 Upload file" (screen record cũng được).',
      'DÙNG KHUÔN: xem "📖 bài học" → bấm "🎬 Tạo video theo khuôn này" hoặc gắn khuôn vào ⏰ Lịch định kỳ ở Video Studio.',
    ],
    tip: 'Khuôn chỉ học CẤU TRÚC (số cảnh, nhịp, góc máy) — không sao chép chữ/hình đối thủ, an toàn bản quyền. Chọn video 15-40s có cấu trúc rõ để khuôn đẹp nhất.',
  },
  {
    id: 'video_publish', icon: '📤', kicker: 'Video A-Z · 5/5', title: 'Duyệt & đăng video — tab ✅ Review & Queue',
    intro: 'Bài video từ lịch định kỳ (hoặc bạn tự tạo) xuất hiện như bài thường, thẻ có icon 🎬 và preview video.',
    steps: [
      'Mở tab ✅ Review & Queue → bài video có caption viết sẵn (hook + tóm tắt + CTA + hashtag brand) — sửa nếu cần.',
      'Đăng ngay hoặc hẹn giờ. Facebook đăng dạng video Page; Instagram đăng dạng REELS (store phải đã nối IG ở tab 📡 Channels).',
      'Metrics (reach/engagement) tự đổ về sau ~6h → tab 🏆 Scoreboard chấm góc content nào thắng để nhân bản.',
      'LỖI THƯỜNG GẶP: render fail → mở project xem dòng lỗi, Render lại · bài không tự đăng → chưa nối kênh hoặc lịch đang chế độ 📝 nháp · video ít chuyển động → nạp thêm clip quay tay.',
    ],
    tip: 'Chế độ 📝 nháp an toàn nhất khi mới dùng — xem 2-3 video đầu đạt chưa rồi hãy chuyển lịch sang ⚡ tự đăng.',
  },
  {
