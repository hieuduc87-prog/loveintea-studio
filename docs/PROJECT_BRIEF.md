...
- [session 2026-08-10] 4 commit — audit bảo mật: 6 CRITICAL + 8 HIGH vá+verify-live (FB OAuth/kanban brief/inbox/cost-DoS/next-auth CVE/COGS leak/path-traversal); Wave2 recordCost+rate-limit+H5/H7; disk-full → tắt tar-ảnh backup.sh. docs(security) · sec(Wave2) · sec(P0) [LIT-SEC-0810A/B]
