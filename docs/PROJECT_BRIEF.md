...
- **2026-07-21 [LIT-DOC-0721A]** (docs-only): Đúc kết công thức đóng tool video từ 6 pipeline (Quizzlee/Quiz Factory/HubVideo/Video Composition/Bazan Recipe/Video Studio v2) thành `docs/video-tool-spec-templates.md` — pipeline chuẩn 8 lớp + 5 phiếu ra đề bài (A đề tổng, B input schema, C timeline theo giây, D visual/audio formula, E nghiệm thu) + 2 ví dụ điền sẵn + bản rút gọn 5 câu hỏi vàng. Cho nhân viên tự ra đề tool video.
