...
- [session 2026-07-31] 12 commit — docs(brief) · docs(tenant) · fix(product-ref) · feat(mask-lock) · fix(fidelity-gate) · feat(fidelity-gate) · fix(reel-engine) · refactor(reel-engine) · fix(tenant-map)
