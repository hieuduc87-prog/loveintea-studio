...
export const config = {
  matcher: [
    ...
    '/((?!api/auth|api/autofix|api/webhooks|api/images|api/payment/webhook|api/payment/momo-callback|login|about|help|plans|api/leads|_next/static|_next/image|favicon.ico|brand/|public/).*)',
  ],
};
